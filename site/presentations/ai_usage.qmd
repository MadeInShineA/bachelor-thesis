...
format:
  revealjs:
    ...
    footer: '<a href="../index.qmd" style="color: inherit; text-decoration: none;">Home</a> | <a href="../sources.qmd" style="color: inherit; text-decoration: none;">Sources</a> | AI Usage Presentation © 2026'
...
- I use exclusively open weight models like [Kimi K2.6](https://huggingface.co/moonshotai/Kimi-K2.6){target="_blank"}
...
- I mostly use LLMs to explain things with extra fact checking or to mess around
- I use LLMs to correct my typo or grammar mistakes
